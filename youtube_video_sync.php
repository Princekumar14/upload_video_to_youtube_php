        ...
        if(!empty($videoData)){ 
            ...
            if(!empty($videoData['youtube_video_id'])){ 
                ...
                try { 
                    ...
                    // This example sets the video's title, description, keyword tags, and video category. 
                    // $snippet = new Google_Service_YouTube_VideoSnippet(); //previously used
                    ...
                    // $status = new Google_Service_YouTube_VideoStatus();  //previously used
                    ...
                    // $video = new Google_Service_YouTube_Video();     //previously used
                    $video = new Video();   
